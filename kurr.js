...
const dtod = "628995820020@s.whatsapp.net"
const otod = "628995820020@s.whatsapp.net"
// STICKER WM
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Abbas Botzゑ v.3.0_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IV4uvaVLE0aATOhglpsQIV', "groupName": `Abbas Botzゑ v.3.0`, "footerText": "*_© Abbas Botzゑ v.3.0_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Abbas Botzゑ v.3.0_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer Abbas Botzゑ v.3.0\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: `${jmn} - ${week}  - ${calender}`,body:"Abbas Botzゑ v.3.0",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/628995820020`}}})
		}
...
if(budy.includes('Abbas Botz')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("628995820020@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
...
cpref = `Hay Saya Abbas Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('assalamualaikum')){
cpref = `Hay Saya Abbas Botz Whatsapp Ketik .menu Untuk Mengakses`
...
kurr.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`💠Bot Active Selama :${kyun(runi)}🆔 `).catch((_)=>_);
...
kurr.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]}})
 ...
 footerText: '*_© Abbas ゑ_*',
 description: `Ohayoo @${stod.split('@')[0]}, Silahkan pilih menu disini`,
 sections: [
                     {
...
_ℒ⃝🌊 ${prefix}othermenu_
 `
sendButLocation(from, `${menu}`, "*_© Abbas ゑ_*", {jpegThumbnail:ofrply2,name:""}, [{buttonId:`info`,buttonText:{displayText:'INFO BOT'},type:1},{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
_ℒ⃝🌊 ${prefix}nano [ _nama file_ ]_             
 `
sendButLocation(from, `${menu}`, "*_© Abbas ゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
_ℒ⃝🌊 ${prefix}greenneon (teks)_
_ℒ⃝🌊 ${prefix}advanceglow (teks)_
_ℒ⃝🌊 ${prefix}futureneon (teks)_
_ℒ⃝🌊 ${prefix}sandwriting (teks)_
_ℒ⃝🌊 ${prefix}sandsummer (teks)_
_ℒ⃝🌊 ${prefix}sandengraved (teks)_
_ℒ⃝🌊 ${prefix}metaldark (teks)_
_ℒ⃝🌊 ${prefix}neonlight (teks)_
_ℒ⃝🌊 ${prefix}holographic (teks)_
_ℒ⃝🌊 ${prefix}text1917 (teks)_
_ℒ⃝🌊 ${prefix}minion (teks)_
_ℒ⃝🌊 ${prefix}deluxesilver (teks)_
_ℒ⃝🌊 ${prefix}newyearcard (teks)_
_ℒ⃝🌊 ${prefix}bloodfrosted (teks)_
_ℒ⃝🌊 ${prefix}halloween (teks)_
_ℒ⃝🌊 ${prefix}jokerlogo (teks)_
_ℒ⃝🌊 ${prefix}fireworksparkle (teks)_
_ℒ⃝🌊 ${prefix}natureleaves (teks)_
_ℒ⃝🌊 ${prefix}bokeh (teks)_
_ℒ⃝🌊 ${prefix}toxic (teks)_
_ℒ⃝🌊 ${prefix}strawberry (teks)_
_ℒ⃝🌊 ${prefix}box3d (teks)_
_ℒ⃝🌊 ${prefix}roadwarning (teks)_
_ℒ⃝🌊 ${prefix}breakwall (teks)_
_ℒ⃝🌊 ${prefix}icecold (teks)_
_ℒ⃝🌊 ${prefix}luxury (teks)_
_ℒ⃝🌊 ${prefix}cloud (teks)_
_ℒ⃝🌊 ${prefix}summersand (teks)_
_ℒ⃝🌊 ${prefix}horrorblood (teks)_
_ℒ⃝🌊 ${prefix}thunder (teks)_
_ℒ⃝🌊 ${prefix}pornhub (teks)_
_ℒ⃝🌊 ${prefix}glitch (teks)_
_ℒ⃝🌊 ${prefix}avenger (teks)_
_ℒ⃝🌊 ${prefix}space (teks)_
_ℒ⃝🌊 ${prefix}ninjalogo (teks)_
_ℒ⃝🌊 ${prefix}marvelstudio (teks)_
_ℒ⃝🌊 ${prefix}lionlogo (teks)_
_ℒ⃝🌊 ${prefix}wolflogo (teks)_
_ℒ⃝🌊 ${prefix}steel3d (teks)_
_ℒ⃝🌊 ${prefix}wallgravity (teks)_
_ℒ⃝🌊 ${prefix}shadow (teks)_
_ℒ⃝🌊 ${prefix}cup (teks)_
_ℒ⃝🌊 ${prefix}cup1 (teks)_
_ℒ⃝🌊 ${prefix}romance (teks)_
_ℒ⃝🌊 ${prefix}smoke (teks)_
_ℒ⃝🌊 ${prefix}burnpaper (teks)_
_ℒ⃝🌊 ${prefix}lovemessage (teks)_
_ℒ⃝🌊 ${prefix}undergrass (teks)_
_ℒ⃝🌊 ${prefix}love (teks)_
_ℒ⃝🌊 ${prefix}coffe (teks)_
_ℒ⃝🌊 ${prefix}woodheart (teks)_
_ℒ⃝🌊 ${prefix}woodenboard (teks)_
_ℒ⃝🌊 ${prefix}summer3d (teks)_
_ℒ⃝🌊 ${prefix}wolfmetal (teks)_
_ℒ⃝🌊 ${prefix}nature3d (teks)_
_ℒ⃝🌊 ${prefix}underwater (teks)_
_ℒ⃝🌊 ${prefix}golderrose (teks)_
_ℒ⃝🌊 ${prefix}summernature (teks)_
_ℒ⃝🌊 ${prefix}letterleaves (teks)_
_ℒ⃝🌊 ${prefix}glowingneon (teks)_
_ℒ⃝🌊 ${prefix}fallleaves (teks)_
_ℒ⃝🌊 ${prefix}flamming (teks)_
_ℒ⃝🌊 ${prefix}harrypotter (teks)_
_ℒ⃝🌊 ${prefix}carvedwood (teks)_
_ℒ⃝🌊 ${prefix}arcade8bit (teks)_
_ℒ⃝🌊 ${prefix}battlefield4 (teks)_
_ℒ⃝🌊 ${prefix}pubg (teks)_
_ℒ⃝🌊 ${prefix}wetglass (teks)_
_ℒ⃝🌊 ${prefix}multicolor3d (teks)_
_ℒ⃝🌊 ${prefix}watercolor (teks)_
_ℒ⃝🌊 ${prefix}luxurygold (teks)_
_ℒ⃝🌊 ${prefix}galaxywallpaper (teks)_
_ℒ⃝🌊 ${prefix}lighttext (teks)_
_ℒ⃝🌊 ${prefix}beautifulflower (teks)_
_ℒ⃝🌊 ${prefix}puppycute (teks)_
_ℒ⃝🌊 ${prefix}royaltext (teks)_
_ℒ⃝🌊 ${prefix}heartshaped (teks)_
_ℒ⃝🌊 ${prefix}birthdaycake (teks)_
_ℒ⃝🌊 ${prefix}galaxystyle (teks)_
_ℒ⃝🌊 ${prefix}hologram3d (teks)_
_ℒ⃝🌊 ${prefix}greenneon (teks)_
_ℒ⃝🌊 ${prefix}glossychrome (teks)_
_ℒ⃝🌊 ${prefix}greenbush (teks)_
_ℒ⃝🌊 ${prefix}metallogo (teks)_
_ℒ⃝🌊 ${prefix}noeltext (teks)_
_ℒ⃝🌊 ${prefix}glittergold (teks)_
_ℒ⃝🌊 ${prefix}textcake (teks)_
_ℒ⃝🌊 ${prefix}starsnight (teks)_
_ℒ⃝🌊 ${prefix}wooden3d (teks)_
_ℒ⃝🌊 ${prefix}textbyname (teks)_
_ℒ⃝🌊 ${prefix}writegalacy (teks)_
_ℒ⃝🌊 ${prefix}galaxybat (teks)_
_ℒ⃝🌊 ${prefix}snow3d (teks)_
_ℒ⃝🌊 ${prefix}birthdayday (teks)_
_ℒ⃝🌊 ${prefix}goldplaybutton (teks)_
_ℒ⃝🌊 ${prefix}silverplaybutton (teks)_
_ℒ⃝🌊 ${prefix}freefire (teks)_
_ℒ⃝🌊 ${prefix}shadow (teks)_
...
case 'meme':
              ...
              buttonsMessage = {footerText:'✗✗✗ Abbas Botz', imageMessage: imageMsg,
...
_ℒ⃝👨‍💻 Name Creator : Abbas Botz_

*🪀GC BOT*
https://chat.whatsapp.com/IV4uvaVLE0aATOhglpsQIV
*📑SC BOT*
https://github.com/Abbas-Botz
...
GITHUB OWNER:https://github.com/Abbas-Botz
YOUTUBE OWNER:https://youtube.com/c/AbbasMods
`
sendButLocation(from, `${menu}`, "*_© AbbasBotzゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'STORE BOT'},type:1},{buttonId:`speed`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
case 'catlog': 
                ...
                nama = ' ゑwelcome to Abbas-Botz storeゑ '
       ownerJid = "628995820020@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menunya = `*Abbas-Botz Melayani Jasa Pembuatan Vps/Rdp*
...
JANGAN LUPA JOIN GC : https://chat.whatsapp.com/IV4uvaVLE0aATOhglpsQIV
*「 Abbas ゑ 」*`
gbutsan = [
...
break
case 'sc':
reply(`SC : https://github.com/Abbas-Botz`)
break
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Abbas ゑ`,
          "url": "https://github.com/Abbas-Botz"
        },
        "index": 0
      }
    ]
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Abbas-Botz`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Abbas ゑ`}, MessageType.location)
...
var nn = body.slice(9)
          ...
          if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(`Jdiin Admin Dlu Bjir🗿`)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY Abbas ゑ`)
...
Link : ${get_resultP.audio}
            ...
            "sourceUrl": "http://Abbas-Botzstore.xyz"
...
break
 ...
 `
sendButLocation(from, `${menu}`, "*_© Abbas ゑ_*", {jpegThumbnail:ofrply3,name:""}, [{buttonId:`owner`,buttonText:{displayText:'OWNER THIS BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer Abbas ゑ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/628995820020"}}})
	}
    }
    }
    }
